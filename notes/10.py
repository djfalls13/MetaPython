...
# External file is lists_5 containing a Class called list_class

from lists_5 import list_class

# External file is lists_5 in a sub-directory pyfiles containing a Class called list_class 


from pyfiles.lists_5 import list_class
